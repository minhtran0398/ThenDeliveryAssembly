...
namespace ThenDelivery.Server.Application.MerchantController.Queries
{
	public class GetMerchantByIdQuery : IRequest<MerchantDto>
	{
		...
		public GetMerchantByIdQuery(int merchantId)
		{
			_merchantId = merchantId;
		}

		public class Handler : IRequestHandler<GetMerchantByIdQuery, MerchantDto>
		{
			private readonly ThenDeliveryDbContext _dbContext;
			private readonly ILogger<GetMerchantByIdQuery> _logger;

			public Handler(ThenDeliveryDbContext dbContext, ILogger<GetMerchantByIdQuery> logger)
			{
